package com.zjx.githubapp.common.utils
...
//    }
    ...
    fun getNewsTimeStr(date: Date?): String {
        ...
        return when {
            subTime < MILLIS_LIMIT -> GitHupApplication.instance.getString(R.string.justNow)
            subTime < SECONDS_LIMIT -> Math.round(subTime / MILLIS_LIMIT).toString() + " " + GitHupApplication.instance.getString(R.string.secondAgo)
            subTime < MINUTES_LIMIT -> Math.round(subTime / SECONDS_LIMIT).toString() + " " + GitHupApplication.instance.getString(R.string.minutesAgo)
            subTime < HOURS_LIMIT -> Math.round(subTime / MINUTES_LIMIT).toString() + " " + GitHupApplication.instance.getString(R.string.hoursAgo)
            subTime < DAYS_LIMIT -> Math.round(subTime / HOURS_LIMIT).toString() + " " + GitHupApplication.instance.getString(R.string.daysAgo)
